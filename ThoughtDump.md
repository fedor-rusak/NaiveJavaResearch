...
But If you try to parse the json.files that are generated by my Analysis-Parsing program then you will find out that there are files with symbols that can't be parsed as UTF-16 bla-bla endian. Well it's 2017 baby and we still fuck with encodings...

After making linking 10 modules I can't understand them with plain reading and I just need some visual help.
